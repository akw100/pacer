...
interface PulsatingButtonProps
  ...
  /** Color of the pulsing ring. Defaults to the button's resolved background (Pacer accent #FF5A36). */
  pulseColor?: string
  duration?: string
  distance?: string
  ...
  (
    ...
    return (
      <button
        ref={innerRef}
        className={cn(
          "bg-accent relative flex cursor-pointer items-center justify-center rounded-card px-4 py-2 text-center font-medium text-white",
          className
        )}
        style={
          {
      ...
      >
        ...
        <span
          ...
          className={cn(
            ...
            variant === "pulse" ? "animate-pulsate" : "animate-pulse-ripple"
          )}
        />
      </button>
    )
