...
export interface BaseParticleOptions {
  ...
  size?: number;
  /**
   * Palette used for the default "circle" particles. Defaults to the Pacer
   * brand colors (coral accent, amber streak, green success). One color is
   * picked at random per particle.
   */
  colors?: string[];
}
